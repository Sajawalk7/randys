...
<div class="container p-t-3">
  ...
  <form id="yith-wcwl-form" action="<?php echo $form_action ?>" method="post" class="woocommerce">
      ...
      if( ! empty( $page_title ) ) :
      ?>
          <div class="wishlist-title row m-t-3 <?php echo ( $is_custom_list ) ? 'wishlist-title-with-form' : ''?>">
              <?php echo apply_filters( 'yith_wcwl_wishlist_title', '<h2>Wishlist</h2>' ); ?>
          ...
          <tr>
            <?php if( $show_cb ) : ?>
              ...
              <th class="product-checkbox">
                <input type="checkbox" value="" name="" aria-label="Bulk Add To Cart" id="bulk_add_to_cart"/>
              </th>
            ...
            ?>
              ...
              <th class="part-number">
                  <span class="nobr"><?php echo apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Part Number', 'yith-woocommerce-wishlist' ) ) ?></span>
              </th>
            ...
            $added_items = array();
              foreach( $wishlist_items as $item ) :
                      ...
                      <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" data-row-id="<?php echo $item['prod_id'] ?>">
                        ...
                        <?php endif ?>
                          ...
                          <td class="part-number">
                              <?php echo get_post_meta($product->get_id(), '_sku', true); ?>
                          </td>
                ...
                <?php if( $available_multi_wishlist && is_user_logged_in() && count( $users_wishlists ) > 1 && $move_to_another_wishlist && $is_user_owner ): ?>
                            <select aria-label="Change Wishlist" class="change-wishlist selectBox">
