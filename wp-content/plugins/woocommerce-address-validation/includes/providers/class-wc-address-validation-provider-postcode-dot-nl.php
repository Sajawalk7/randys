 ...
 *
 * @package     WC-Address-Validation/Provider/Postcode-Nl
 * @author      SkyVerge
...
class WC_Address_Validation_Provider_Postcode_Dot_Nl extends WC_Address_Validation_Provider {
	...
	public function is_configured() {
		...
		return $this->app_key && $this->app_secret ? true : false;
	}
...
} // end \WC_Address_Validation_Provider_Postcode_Dot_Nl class
