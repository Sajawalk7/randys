 ...
 */
define( 'WOOCOMMERCESEA_PLUGIN_VERSION', '2.6.4' );
...
function woosea_license_valid(){
	...
	$license_information = get_option('license_information');
        ...
        $curl = curl_init();
        $url = "https://www.adtribes.io/check/license.php?key=$license_information[license_key]&email=$license_information[license_email]&domain=$domain&version=2.6.4";
